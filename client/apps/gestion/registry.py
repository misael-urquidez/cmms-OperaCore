...
GESTION_REGISTRY = {
    ...
    "planta": {
        ...
        "campos": [
            ...
            {"name": "dircalle", "label": "Calle", "tipo": "text", "requerido": True, "columna": True},
            {"name": "dircodigopostal", "label": "Código postal", "tipo": "text", "requerido": True, "columna": True},
            {"name": "dirnumero", "label": "Número", "tipo": "text", "requerido": True, "columna": True},
        ],
    },
    ...
    "linea": {
        ...
        "campos": [
            ...
            {"name": "nombre", "label": "Nombre", "tipo": "text", "requerido": True, "columna": True},
            {"name": "descripcion", "label": "Descripción", "tipo": "textarea", "requerido": False, "columna": False},
            {"name": "telefono", "label": "Teléfono", "tipo": "text", "requerido": False, "columna": False},
            {"name": "area", "label": "Área", "tipo": "select", "requerido": True, "columna": True,
    ...
    "maquina": {
        ...
        "campos": [
            ...
            {"name": "modelo", "label": "Modelo", "tipo": "select", "requerido": False, "columna": True,
             ...
             "fk_parent": "marca", "fk_parent_key": "marca",
    ...
    "proveedor": {
        ...
        "campos": [
            ...
            {"name": "nombrecomercial", "label": "Nombre comercial", "tipo": "text", "requerido": True, "columna": True},
            {"name": "telefono", "label": "Teléfono", "tipo": "text", "requerido": True, "columna": True},
            {"name": "email", "label": "Email", "tipo": "text", "requerido": True, "columna": True},
            {"name": "dircalle", "label": "Calle", "tipo": "text", "requerido": True, "columna": True},
            {"name": "dircodigopostal", "label": "Código postal", "tipo": "text", "requerido": True, "columna": True},
            {"name": "dirnumero", "label": "Número", "tipo": "text", "requerido": True, "columna": True},
            {"name": "contnombre", "label": "Contacto - nombre", "tipo": "text", "requerido": True, "columna": True},
            {"name": "contapellpat", "label": "Contacto - apellido paterno", "tipo": "text", "requerido": True, "columna": True},
    ...
    "pieza": {
        ...
        "campos": [
            ...
            {"name": "nombre", "label": "Nombre", "tipo": "text", "requerido": True, "columna": True},
            {"name": "costoinicial", "label": "Costo inicial", "tipo": "float", "requerido": True, "columna": True},
            {"name": "horasoperacion", "label": "Horas de operación", "tipo": "int", "requerido": False, "columna": False},
            {"name": "tiempovidautil", "label": "Vida útil (meses)", "tipo": "int", "requerido": True, "columna": True},
    ...
    "refaccion": {
        ...
        "campos": [
            ...
            {"name": "codigoinventario", "label": "Código de inventario", "tipo": "text", "requerido": True, "columna": True},
            {"name": "numeroorden", "label": "Número de orden", "tipo": "text", "requerido": True, "columna": True},
            {"name": "costo", "label": "Costo", "tipo": "float", "requerido": True, "columna": True},
            {"name": "tiempoentregaapr", "label": "Tiempo de entrega aprox. (días)", "tipo": "int", "requerido": False, "columna": False},
            {"name": "stock", "label": "Stock", "tipo": "int", "requerido": True, "columna": True},
            {"name": "stockminimo", "label": "Stock mínimo", "tipo": "int", "requerido": True, "columna": True},
    ...
    "trabajador": {
        ...
        "campos": [
            ...
            {"name": "apellidoMat", "label": "Apellido materno", "tipo": "text", "requerido": True, "columna": False},
            {"name": "telefono", "label": "Teléfono", "tipo": "text", "requerido": True, "columna": True},
            ...
            {"name": "rol", "label": "Rol", "tipo": "select", "requerido": True, "columna": True,
             "fk": "rol", "fk_value": "codigo", "fk_label": "nombre"},
            {"name": "especialidad", "label": "Especialidad", "tipo": "select", "requerido": True, "columna": False,
    ...
    "tarea": {
        ...
        "campos": [
            ...
            {"name": "actividad", "label": "¿Activa?", "tipo": "select", "requerido": True, "columna": True,
             "opciones": [{"value": 1, "label": "Sí"}, {"value": 0, "label": "No"}], "es_booleano": True},
        ],
    },
    "tipo-movimiento": {
    ...
    "tarea-orden": {
        ...
        "campos": [
            ...
            {"name": "horainicio", "label": "Hora de inicio", "tipo": "time", "requerido": True, "columna": True},
            {"name": "horafin", "label": "Hora de fin", "tipo": "time", "requerido": False, "columna": False},
            {"name": "verificacion", "label": "¿Verificado?", "tipo": "select", "requerido": False, "columna": True,
             "opciones": [{"value": 1, "label": "Sí"}, {"value": 0, "label": "No"}], "es_booleano": True},
