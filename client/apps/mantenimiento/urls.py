...
urlpatterns = [
    ...
    path("ordenes/<str:folio>/detalle/", views.OrdenDetalleAPIView.as_view(), name="ordenes-detalle"),
    path("ordenes/<str:folio>/cancelar/", views.OrdenCancelarAPIView.as_view(), name="ordenes-cancelar"),
    path("tareas/crear/", views.TareaCrearAPIView.as_view(), name="tareas-crear"),
    path("ordenes/<str:folio>/tareas/<str:tarea>/verificar/", views.TareaOrdenVerificarAPIView.as_view(), name="tarea-orden-verificar"),
